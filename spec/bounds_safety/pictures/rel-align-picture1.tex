...
% x, y, and z variables
\draw (2* \rectsize pt + \rectsize/2, \rectsize*2.5 pt) node[name=y]{\texttt{y}};
\draw (\xindex * \rectsize pt + \rectsize/2, \rectsize*2.5 pt) node[name=x]{\texttt{x}};
\draw (8* \rectsize pt + \rectsize/2, \rectsize*2.5 pt) node[name=z]{\texttt{z}};
