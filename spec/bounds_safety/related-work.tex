...
If a C program and the libraries that it uses have been converted to use 
...
Stack canaries \cite{Cowan1998, Dang2015, Petsio2015} provide 
...
vanderVeen2015, Wang2010,Wang2015, ZhangSP2013,ZhangSEC2013,Zhang2015}.
In a system implementing CFI, runtime checks are added to machine code to ensure that a program follows an approximation of the valid control-flow of the program.  CFI does not defend against data modification or data disclosure attacks.  It is vulnerable to data
...
\cite{GCCCFG2016,LLVMCFG2016,MicrosoftCFG2016, Tice2014}.  It 
...
Second, the checks are imprecise because the control-flow graph
is an approximation, making it possible for
determined attackers to still construct attacks \cite{Carlini2015,
Conti2015, Evans2015, Goktas2014}.
...
imprecision. Evans {\it et al} \cite{Evans2015} explain how the imprecision of pointer 
analysis necessarily leads
to imprecise control-flow graphs in practice.  Because of the imprecision, an attacker could create mismatched call/return sequences.  See \cite{Horwitz1990}
for an explanation of how interprocedural control-flow graphs differ from
 ...
 To do:discuss code pointer integrity, address-guardpapers.
