...
The following rules apply to a conversion of a value of one safe
pointer type to a value of another 

%For a conversion  a value of one safe pointer type to another safe 
%pointer to maintain bounds safety at runtime, the following rules
%apply.
%\begin{itemize}
%\item When converting to a \ptrT, the source pointer must point
%to memory at least as large as \var{T}
%\item When converting from a 
%\item When converting to an \arrayviewT, two differ
%\end{itemize}
