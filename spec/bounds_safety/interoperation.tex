...
\texttt{bounds\_cast<}\var{T}\texttt{\textgreater{}},
\texttt{core\_bounds\_cast<}\var{T}\texttt{\textgreater{}},
and \texttt{assume\_bounds\_cast<}T\texttt{\textgreater{}}.
...
\texttt{bounds\_cast<}\var{T}\texttt{\textgreater{}} uses
...
\begin{itemize}
\item
  \texttt{bounds\_cast<}\var{T}\texttt{\textgreater{}(}\var{e1},
  \var{e2}\texttt{)} converts \var{e1} to an \arrayptr or
  \arrayview type with bounds
  \texttt{count(}\var{e2}\texttt{)}.
\item
  \texttt{bounds\_cast<}\var{T}\texttt{\textgreater{}(}\var{e1}\texttt{,}
...
\item
  ...
  \texttt{bounds\_cast<}T\texttt{\textgreater{}(}e1,
...
\subsection{Correctness of bounds\_cast<T\textgreater{} conversions}
...
We discuss only
\texttt{bounds\_cast<T\textgreater{}(}\var{e1}\texttt{,}
...
\subsection{Static checking use core\_bounds\_cast<T\textgreater{}}
