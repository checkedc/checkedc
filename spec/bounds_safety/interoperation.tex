...
\section{Bounds-safe interfaces for structure types}
\label{section:structure-bounds-safe-interfaces}

Existing structure types can have bounds-safe interfaces declared
...
The \emph{semantics of unchecked
...
\item Complete structure types with members with bounds declarations.
