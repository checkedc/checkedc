...
will be done at \lstinline+&a[i]+ and \lstinline+&b[0]+.
...
\section{Relative alignment of \plainarrayptr\ values}
...
\lstinline+src+ and \texttt{\lstinline+src_count+ \textgreater{} \lstinline+0+}. A compiler could
