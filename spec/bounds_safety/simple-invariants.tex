...
about bounds.  A fact is a bounds declaration or an equality expression.

\begin{tabbing}
\var{fact:}\=\\
\>\var{bounds-declaration} \\
\>\var{equality-expression}
\end{tabbing}
...
An equality expression occurring as part of a fact must be a non-modifying
expression.
...
will check that equality facts in the \keyword{where} clause are true
