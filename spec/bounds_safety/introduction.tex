...
This document is a work-in-progress.  Some material will be missing
or incomplete because the language design is still being done.
...
Chapters~\ref{chapter:core-extensions} through \ref{chapter:aliased-members}
...
Here are the suggest roadmaps for the different audiences of this
document.  For programmers interested in learning about Checked C, 
...
Chapter~\ref{chapter:structure-bounds} except for Section~\ref{section:member-bounds-state-extent},
