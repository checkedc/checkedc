...
We address this problem two ways. First,  the rules that compilers
...
of program logics, the rules are incomplete.   As an example, the size
of expressions that rules about distributivity limit the size of
expressions that they produce.   In practice, this means in practice that 
...
Here are the principles that we apply to extending C to support bounds checking:
