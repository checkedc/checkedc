...
variables are assumed implicitly to have holds declarations for the
...
Mmeber bounds state declarations must be consistent and agree
...
An epression statement is checked by determining the updated context for the
...
determing bounds.   The notation \boundsinfer{\var{e}}{\var{s}} is overloaded for expressions
