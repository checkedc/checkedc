...
\lstinline|&*|\&*\var{e1}. Subscript expressions behave similarly to pointer
...
\boundsdecl{c}{\boundscount{clen}}.  A different bounds declaration for \code{c}
