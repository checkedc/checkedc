...
void f0(void) {
	...
	array_ptr<int> q : count(i2) = p; // expected-error {{it is not possible to prove that the inferred bounds of 'q' imply the declared bounds of 'q' after initialization}} \
                                      // expected-note {{the inferred upper bounds use the value of the variable 'i1', and there is no relational information between 'i1' and any of the variables used by the declared upper bounds}} \
                                      // expected-note {{the declared upper bounds use the value of the variable 'i2', and there is no relational information between 'i2' and any of the variables used by the inferred upper bounds}} \
	...
	array_ptr<int> p3 : bounds(a + len2, a + len1) = p2; // expected-error {{it is not possible to prove that the inferred bounds of 'p3' imply the declared bounds of 'p3' after initialization}} \
                                                         // expected-note {{the inferred lower bounds use the value of the variable 'len1', and there is no relational information between 'len1' and any of the variables used by the declared lower bounds}} \
                                                         // expected-note {{the declared upper bounds use the value of the variable 'len1', and there is no relational information between 'len1' and any of the variables used by the inferred upper bounds}} \
	...
	array_ptr<int> p5 : bounds((p5 + len2) + 0, (p5 + len2) + 1) = p4; // expected-error {{it is not possible to prove that the inferred bounds of 'p5' imply the declared bounds of 'p5' after initialization}} \
                                                                       // expected-note {{the inferred bounds use the value of the variable 'len1', and there is no relational information between 'len1' and any of the variables used by the declared bounds}} \
	...
	array_ptr<int> p7 : count(i1) = p6; // expected-error {{it is not possible to prove that the inferred bounds of 'p7' imply the declared bounds of 'p7' after initialization}} \
                                        // expected-note {{the declared upper bounds use the value of the variable 'i1', and there is no relational information between 'i1' and any of the variables used by the inferred upper bounds}} \
                                        // expected-note {{the inferred upper bounds use the value of the variable 'len1', and there is no relational information between 'len1' and any of the variables used by the declared upper bounds}} \
	...
	p10 = p8; // expected-error {{it is not possible to prove that the inferred bounds of 'p10' imply the declared bounds of 'p10' after assignment}} \
              // expected-note {{the declared upper bounds use the value of the variable 'v', and there is no relational information between 'v' and any of the variables used by the inferred upper bounds}} \
              // expected-note {{the inferred upper bounds use the value of the variable 'i1', and there is no relational information between 'i1' and any of the variables used by the declared upper bounds}} \
	...
	p10 = p9; // expected-error {{it is not possible to prove that the inferred bounds of 'p10' imply the declared bounds of 'p10' after assignment}} \
              // expected-note {{the declared upper bounds use the value of the variable 'v', and there is no relational information between 'v' and any of the variables used by the inferred upper bounds}} \
              // expected-note {{the inferred upper bounds use the value of the variable 'i2', and there is no relational information between 'i2' and any of the variables used by the declared upper bounds}} \
              // expected-note {{the inferred upper bounds use the value of the variable 'i1', and there is no relational information between 'i1' and any of the variables used by the declared upper bounds}} \
...
void f3(struct S1 a3) {
	...
	a3.p = p; // expected-error {{it is not possible to prove that the inferred bounds of a3.p imply the declared bounds of a3.p after assignment}} \
              // expected-note {{the declared upper bounds use the value of the variable 'a3', and there is no relational information between 'a3' and any of the variables used by the inferred upper bounds}} \
