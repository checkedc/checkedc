...
void int_local_var_bounds_decl(void) {
  ...
  long int t22 : byte_count(5 * sizeof(int)) = (long int)a1; // expected-error {{it is not possible to prove that the inferred bounds of 't22' imply the declared bounds of 't22' after initialization}}
  unsigned long int t23 : byte_count(5 * sizeof(int)) = (unsigned long int) a1; // expected-error {{it is not possible to prove that the inferred bounds of 't23' imply the declared bounds of 't23' after initialization}}
