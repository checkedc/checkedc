...
extern void f1() {
  ...
  array_ptr<int> t12 : byte_count(c1) = 0;
  array_ptr<int> t13 : byte_count(c2) = 0;
  array_ptr<int> t14 : byte_count(c3) = 0;
  array_ptr<int> t15 : byte_count(c4) = 0;
  array_ptr<int> t16 : byte_count(c5) = 0;
  array_ptr<int> t17 : byte_count(c6) = 0;
  array_ptr<int> t18 : byte_count(c7) = 0;
  array_ptr<int> t19 : byte_count(c8) = 0;
  array_ptr<int> t20 : byte_count(c9) = 0;
  array_ptr<int> t21 : byte_count(c10) = 0;
  array_ptr<int> t22 : byte_count(c11) = 0;
}
...
#ifndef __STDC_NO_COMPLEX__
  array_ptr<int> t9 : count(c8) = 0;   // expected-error {{invalid argument type}}
#endif

  array_ptr<int> t10 : byte_count(c1) = 0;   // expected-error {{invalid argument type 'float' to byte_count expression}}
  array_ptr<int> t11 : byte_count(c2) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t12 : byte_count(c3) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t13 : byte_count(c4) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t14 : byte_count(c5) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t15 : byte_count(c6) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t16 : byte_count(c7) = 0;  // expected-error {{invalid argument type}}
  array_ptr<int> t17 : byte_count(s.f) = 0;  // expected-error {{invalid argument type}}
#ifndef __STDC_NO_COMPLEX__
  array_ptr<int> t18 : byte_count(c8) = 0;   // expected-error {{invalid argument type}}
#endif
