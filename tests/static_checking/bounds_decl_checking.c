...
extern void check_exprs(int *arg1, ptr<int> arg2, array_ptr<int> arg3,
  ...
  arg4 = &arr[4];         // expected-warning {{cannot prove declared bounds for 'arg4' are valid after statement}}
  ...
  g3 = g1;
  g4 = g1;            // expected-error {{inferred bounds for 'g4' are unknown after statement}}
  ...
  g3 = g3;
  g4 = g3;            // expected-error {{inferred bounds for 'g4' are unknown after statement}}
  ...
  arg3 = g1;
  arg4 = g1;            // expected-error {{inferred bounds for 'arg4' are unknown after statement}}
  ...
  arg3 = g3;
  arg4 = g3;            // expected-error {{inferred bounds for 'arg4' are unknown after statement}}
  ...
  g3 = arg1;
  g4 = arg1;            // expected-error {{inferred bounds for 'g4' are unknown after statement}}
  ...
  g3 = arg3;
  g4 = arg3;            // expected-error {{inferred bounds for 'g4' are unknown after statement}}
  ...
  t3 = arg1;
  t4 = arg1;            // expected-error {{inferred bounds for 't4' are unknown after statement}}
  ...
  t3 = arg3;
  t4 = arg3;            // expected-error {{inferred bounds for 't4' are unknown after statement}}
  ...
  t3 = g2;
  t4 = g1;            // expected-error {{inferred bounds for 't4' are unknown after statement}}
  ...
  g3 = t4;
  g4 = t1;            // expected-error {{inferred bounds for 'g4' are unknown after statement}}
  ...
  t5 = (arg4 = t4);
  t5 = (t4 = arg4);
  t5 = (t4 = t3);     // expected-error {{inferred bounds for 't5' are unknown after statement}} \
                      // expected-error {{inferred bounds for 't4' are unknown after statement}}
...
extern void check_exprs_nullterm(nt_array_ptr<int> arg1 : bounds(unknown),
  ...
  arg2 = (nt_array_ptr<int>)0xabcd;  // expected-error {{inferred bounds for 'arg2' are unknown after statement}}
  arg3 = (nt_array_ptr<int>)0xabcd;  // expected-error {{inferred bounds for 'arg3' are unknown after statement}}
  ...
  // globals assigned from a global
  g11 = g11;
  g12 = g11;           // expected-error {{inferred bounds for 'g12' are unknown after statement}}
  g13 = g11;           // expected-error {{inferred bounds for 'g13' are unknown after statement}}

  g11 = g12;
  g12 = g12;
  g13 = g12;           // expected-error {{declared bounds for 'g13' are invalid after statement}}
  ...
  // parameters assigned from a global
  arg1 = g11;
  arg2 = g11;           // expected-error {{inferred bounds for 'arg2' are unknown after statement}}
  arg3 = g11;           // expected-error {{inferred bounds for 'arg3' are unknown after statement}}

  arg1 = g12;
  arg2 = g12;
  arg3 = g12;           // expected-error {{declared bounds for 'arg3' are invalid after statement}}
  ...
  // globals assigned from parameters
  g11 = arg1;
  g12 = arg1;           // expected-error {{inferred bounds for 'g12' are unknown after statement}}
  g13 = arg1;           // expected-error {{inferred bounds for 'g13' are unknown after statement}}
  ...
  t1 = arg1;
  t2 = arg1;            // expected-error {{inferred bounds for 't2' are unknown after statement}}
  t3 = arg1;            // expected-error {{inferred bounds for 't3' are unknown after statement}}

  t1 = arg2;
  t2 = arg2;
  t3 = arg2;            // expected-error {{declared bounds for 't3' are invalid after statement}}
  ...
  c1 = c2;
  c2 = c1;            // expected-warning {{cannot prove declared bounds for 'c2' are valid after statement}}
  c1 = c3;
  c1 = c4;            // expected-warning {{cannot prove declared bounds for 'c1' are valid after statement}}

  // spot-check locals assigned from globals
  t1 = g13;
  t2 = g12;
  t3 = g11;            // expected-error {{inferred bounds for 't3' are unknown after statement}}

  // spot-check globals assigned from locals
  g11 = t2;
  g12 = t3;
  g13 = t1;            // expected-error {{inferred bounds for 'g13' are unknown after statement}}
  ...
  t4 = (t3 = arg3);
  t4 = (t2 = arg3);
  t4 = (t2 = t1);     // expected-error {{inferred bounds for 't2' are unknown after statement}} \
                      // expected-error {{inferred bounds for 't4' are unknown after statement}}
  ...
  *t3 = 3;
  ...
  t2 = s.f1;          // expected-error {{inferred bounds for 't2' are unknown after statement}}
  t2 = s.f2;
  t2 = s.f3;

  t3 = s.f1;          // expected-error {{inferred bounds for 't3' are unknown after statement}}
...
extern void check_nullterm_call_bsi(int *arg1 : itype(nt_array_ptr<int>),
  ...
  _Checked{
    ...
    arg1 = arg2;                 // expected-error {{inferred bounds for 'arg1' are unknown after statement}}
...
void check_nullterm_return_use(void) {
  ...
  p = nullterm_return2(); // expected-error {{inferred bounds for 'p' are unknown after statement}}
}
