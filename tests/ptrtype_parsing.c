...
//
// Test that the new types can be used as parameter types, return types, 
// local variable types, and structure member types.  Also check the case
// ptr<ptr<T>>, where >> could be mistaken for the right-shift operator.
//
