...
//
// RUN: %clang -fcheckedc-extension %s -o %t6 -DTEST_WRITE -Werror -O3
...
// RUN: %clang -fcheckedc-extension %s -o %t7 -DTEST_INCREMENT -Werror -O3
...
// RUN: %clang -fcheckedc-extension %s -o %t8 -DTEST_COMPOUND_ASSIGN -Werror -O3
