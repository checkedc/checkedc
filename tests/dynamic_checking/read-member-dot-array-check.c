...
void passing_test_3(struct S1 s, int i);

void failing_test_1(int i);
void failing_test_3(struct S1 s, int i);
...
void passing_test_1(int i) {
  assert(0 <= i && i < 10);
  struct S1 s = { { 9, 8, 7, 6, 5, 4, 3, 2, 1, 0 }, 10};
  printf("Printable: %d\n", s.arr[i]);
