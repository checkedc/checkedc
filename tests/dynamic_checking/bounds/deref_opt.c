...
//
// RUN: %clang -fcheckedc-extension %S\deref.c -o %t2 -DTEST_WRITE -Werror
...
// RUN: %clang -fcheckedc-extension %S\deref.c -o %t3 -DTEST_INCREMENT -Werror
...
// RUN: %clang -fcheckedc-extension %S\deref.c -o %t4 -DTEST_COMPOUND_ASSIGN -Werror
