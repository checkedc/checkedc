...
//
// RUN: %clang -fcheckedc-extension %s -o %t1 -DTEST_READ -DARROW_OPERATOR -Werror -Wno-unused-value
...
// RUN: %t1 pass5 | FileCheck %s --check-prefixes=CHECK,CHECK-PASS,ARROW,PASS-5-READ
...
// RUN: %t2 pass5 | FileCheck %s --check-prefixes=CHECK,CHECK-PASS,ARROW,PASS-5-WRITE
...
// RUN: %t3 pass5 | FileCheck %s --check-prefixes=CHECK,CHECK-PASS,ARROW,PASS-5-INCREMENT
...
// RUN: %t4 pass5 | FileCheck %s --check-prefixes=CHECK,CHECK-PASS,ARROW,PASS-5-COMPOUND-ASSIGN
...
// RUN: %clang -fcheckedc-extension %s -o %t5 -DTEST_READ -Werror -Wno-unused-value
...
// RUN: %t5 pass5 | FileCheck %s --check-prefixes=CHECK,CHECK-PASS,PASS-5-READ
...
// RUN: %t6 pass5 | FileCheck %s --check-prefixes=CHECK,CHECK-PASS,PASS-5-WRITE
...
// RUN: %t7 pass5 | FileCheck %s --check-prefixes=CHECK,CHECK-PASS,PASS-5-INCREMENT
...
// RUN: %t8 pass5 | FileCheck %s --check-prefixes=CHECK,CHECK-PASS,PASS-5-COMPOUND-ASSIGN
